...
$onepiece = query("SELECT img, nama_komik, harga, pengarang.nama_pengarang FROM komik JOIN pengarang ON komik.pengarang_id = pengarang.id_pengarang WHERE nama_komik LIKE '%One Piece%'");
?>
...
<body>
  <h1 class="text-center mt-4 mb-4">One Piece</h1>
