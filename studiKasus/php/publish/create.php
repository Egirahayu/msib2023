...
<head>
    ...
    <title>ER-Book | Add Data Publisher</title>
        ...
        <div class=" container">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="card-panel">
                    <h5>Form Add Data Publisher</h5>
                    <div class="input-field">
                        <input type="text" name="nama_penerbit" id="nama_penerbit" class="validate" autocomplete="off">
                    ...
                    <button class="waves-effect waves-light orange darken-4 btn" type="submit" name="add_publish">Add Data!</button>
