...
$id = $_GET['id'];
$categories = query("SELECT category.id, nama_category FROM category WHERE category.id = $id")[0];
        ...
        <div class=" container">
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card-panel">
                    <h5>Form Update Data Category</h5>
                    <div class="input-field">
                        <input type="text" name="nama_category" id="nama_category" required value="<?= $categories["nama_category"]; ?>">
