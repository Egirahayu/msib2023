...
$id = $_GET['id'];
$auth = query("SELECT pengarang.id, nama_pengarang, tgl_lahir, alamat FROM pengarang WHERE pengarang.id = $id")[0];
...
<head>
    ...
    <title>ER-Book | Update Data Category</title>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="card-panel">
                    ...
                    <div class="input-field">
                        <input type="text" name="nama_pengarang" id="nama_pengarang" required value="<?= $auth["nama_pengarang"]; ?>">
                    ...
                    <div class="input-field">
                        <textarea name="alamat" id="alamat" required class="materialize-textarea"><?= $auth["alamat"]; ?></textarea>
                        <label for="alamat">Description</label>
                    </div>
                    <button class="waves-effect waves-light orange darken-4 btn" type="submit" name="update_author">Update Data!</button>
