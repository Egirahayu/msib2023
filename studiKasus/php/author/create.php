...
<head>
    ...
    <title>ER-Book | Add Data Author</title>
        ...
        <div class=" container">
            <form action="" method="post" enctype="multipart/form-data">
                <div class="card-panel">
                    <h5>Form Add Data Author</h5>
                    <div class="input-field">
                        <input type="text" name="nama_pengarang" id="nama_pengarang" class="validate" autocomplete="off">
                        <label for="nama_pengarang">Author</label>
                    </div>
                    <div class="input-field">
                        <input type="date" name="tgl_lahir" id="tgl_lahir" class="validate" autocomplete="off">
