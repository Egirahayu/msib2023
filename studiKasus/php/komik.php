...
$komik = query("SELECT komik.id, nama_komik, tahun, harga, category.nama_category, penerbit.nama_penerbit, pengarang.nama_pengarang
FROM komik
                ...
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
                    ...
                    <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link d-flex align-items-center gap-2 active" href="komik.php">
                                    <svg class="bi">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="container">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        <h1 class="h2">Manga</h1>
                    </div>

                    <div class="table-responsive col-lg-11">
                        <a href="komik/create.php" class="btn btn-primary mb-3">Create Manga</a>
                        ...
                        <table class="table table-striped table-sm">
                            ...
                            <tbody>
                                <?php foreach ($komik as $manga) : ?>
                                    <tr>
                                        <td><?= $i; ?>.</td>
                                        <td><?= $manga['nama_komik']; ?></td>
                                        <td><?= $manga['tahun']; ?></td>
                                        <td><?= number_format($manga['harga'], 0, ',', '.'); ?></td>
                                        <td><?= $manga['nama_category']; ?></td>
